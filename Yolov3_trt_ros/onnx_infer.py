...
def main():
    ...
    img = cv2.imread("./datasets/data_object_image_2/testing/image_2/000315.png", cv2.IMREAD_COLOR)
    ...
    x_test = torch.randn(1, 3, 416, 416, requires_grad=True).to(torch.device("cuda:0"))
    def to_numpy(tensor):
